...
function HomePage() {
          ...
          <Box display={{base : 'none' , md: 'block'}}>
              <Grid templateColumns={'repeat(16, 1fr)'} gap={'20px'}>
                  ...
                  <GridItem colStart={4} colEnd={10} >
                          <Image paddingBottom={5} width={{md : '240px' , lg : '340px'}} src='https://i.postimg.cc/wBFZ6bJk/img-9.jpg' />
                      <Image  width={{md : '240px' , lg : '340px'}}  src='https://i.postimg.cc/LXCcV08s/img-6.jpg' />
                  </GridItem>
 ...
 <Image  src='https://i.postimg.cc/Kc9G9JHB/img-1.jpg' />
                  ...
                  <GridItem colStart={11} colEnd={14}>
                      <Image paddingBottom={5}width={{md : '240px' , lg : '340px'}} src='https://i.postimg.cc/cJdPGNKH/img-13.jpg' />
